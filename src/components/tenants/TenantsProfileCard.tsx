...
const menuItems = [
  { label: "Tenants Profile", href: "/tenants/profile" },
  { label: "Current Booking", href: "/tenants/current-bookings" },
  { label: "Previous Bookings", href: "/tenants/previous-bookings" },
  { label: "Search Properties", href: "/properties" },
  { label: "Profile Verification", href: "/tenants/profile-verification" },
  { label: "Messages", href: "/tenants/messages" },
  { label: "Help/Support", href: "/tenants/help" },
  { label: "Tenancy Agreement", href: "/tenants/tenancy-agreement" },
];

export default function TenantsProfileCard() {
  ...
  return (
    <>
      <div className="w-full h-[30rem] max-w-xs bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-center">
